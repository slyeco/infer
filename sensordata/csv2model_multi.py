...
if __name__ == "__main__":
    ...
    parser.add_argument('output_file', type=str, help='/home/max/infer/models/rf_multi.joblib')
    
    args = parser.parse_args()
    
    # Define file paths and labels
    files = [
        '/home/max/infer/sensordata/enimix_air.csv',
        '/home/max/infer/sensordata/enimix_ammonia.csv',
        '/home/max/infer/sensordata/enimix_benzina.csv',
        '/home/max/infer/sensordata/enimix_gasolio.csv'
    ]
    labels = ['air', 'ammonia', 'benzina', 'gasolio']
